...
d = {
    ...
    'Newcomer of the Year': [
        ...
        (2014, 'Pedro Morales'),
        (2015, 'Sebastian Giovinco'),
        (2016, 'Nicolas Loderio'),
        (2017, 'Miguel Almiron'),
        (2018, 'Zlatan Ibrahimovic'),
        (2019, 'Carles Gil'),
        (2020, 'Lucas Zelarayan'),
        (2021, 'Cristian Arango'),
        (2022, 'Thiago Almada'),
        (2023, 'Giorgos Giakoumakis'),
        (2024, 'Gabriel Pec'),
        (2025, 'Anders Dreyer'),
        ],
    ...
    'Comeback Player of the Year': [
        ...
        (2018, 'Gyasi Zardes'),
        (2019, 'Jordan Morris'),
        (2020, 'Bradley Wright-Phillips'),
        (2021, 'Carles Gil'),
        (2022, 'Gonzalo Higuain'),
        (2023, 'Alan Pulido'),
        (2024, 'Lewis Morgan'),
        (2025, 'Nick Hagglund'),
        ],
