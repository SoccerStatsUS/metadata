...
HALL_DIR = os.path.join(ROOT_DIR, 'metadata/data/lists/awards/halloffame')
...
def process_nasl_awards():
    from metadata.data.lists.awards.nasl import d
    return process_awards(d)


def process_guatemala_awards():
    from metadata.data.lists.awards.guatemala import d
    return process_awards(d)

def process_panama_awards():
    from metadata.data.lists.awards.panama import d
    return process_awards(d)

def process_elsalvador_awards():
    from metadata.data.lists.awards.elsalvador import d
    return process_awards(d)

def process_nicaragua_awards():
    from metadata.data.lists.awards.nicaragua import d
    return process_awards(d)


def process_honduras_awards():
    from metadata.data.lists.awards.honduras import d
    return process_awards(d)

def process_costa_rica_awards():
    from metadata.data.lists.awards.costa_rica import d
    return process_awards(d)
...
def process_conmebol_league_awards():
    from metadata.data.lists.awards import conmebol_league
...
def process_brazil_awards():
    from metadata.data.lists.awards.brazil import brasileirao, mineiro, carioca, paulista, gaucho, baiano
...
def process_argentina_awards():
    from metadata.data.lists.awards.argentina import d, metropolitano
...
def process_ny_awards():
    from metadata.data.lists.awards import ny
...
def process_australia_awards():
    from metadata.data.lists.awards.australia import d
    return process_awards(d)



def process_china_awards():
    from metadata.data.lists.awards.china import d
    return process_awards(d)

def process_japan_awards():
    from metadata.data.lists.awards.japan import d
    return process_awards(d)

def process_korea_awards():
    from metadata.data.lists.awards.korea import d
    return process_awards(d)



def process_olympics_awards():
    from metadata.data.lists.awards.olympics import d
    return process_awards(d)


def process_conmebol_awards():
    from metadata.data.lists.awards.conmebol2 import copa_merconorte, copa_mercosur, copa_sudamericana, masters, copa_conmebol, copa_tie, copa_aldao, recopa_sudamericana
    from metadata.data.lists.awards.conmebol import copa_libertadores
...
def process_conmebol_international_awards():
    from metadata.data.lists.awards.conmebol import copa_america
    return process_awards(copa_america) 


def process_panamerican_awards():
    from metadata.data.lists.awards.panamerican import pac, pag
    return process_awards(pag) + process_awards(pac)

def process_indoor_awards():
    from metadata.data.lists.awards import indoor as i
...
def process_us_open_cup_awards():
    from metadata.data.lists.awards.usopencup import d
    return process_awards(d)

def process_lewis_cup_awards():
    from metadata.data.lists.awards.lewis import d
    return process_awards(d)

def process_asl2_awards():
    from metadata.data.lists.awards.asl import d
    return process_awards(d)

def process_asl_awards():
    from metadata.data.lists.awards.asl0 import d
    return process_awards(d)


def process_nafbl_awards():
    from metadata.data.lists.awards.nafbl import nafbl
    return process_awards(nafbl)

def process_snesl_awards():
    from metadata.data.lists.awards.nafbl import snesl
    return process_awards(snesl)


def process_esl_awards():
    from metadata.data.lists.awards.asl0 import esl
    return process_awards(esl)



def process_ncaa_awards():
    from metadata.data.lists.awards.ncaa import men, women
...
def process_usl_awards():
    from metadata.data.lists.awards import usl, usisl
    l = []
...
def process_pdl_awards():
    from metadata.data.lists.awards import usl
    return process_awards(usl.usl_pdl)

def process_world_cup_awards():
    from metadata.data.lists.awards.world_cup import world_cup, u20, u17
